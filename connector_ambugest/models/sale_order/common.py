...
class AmbugestSaleOrder(models.Model):
    _name = 'ambugest.sale.order'
    _inherit = 'ambugest.binding'
    _description = 'Ambugest Sale Order'
    ...
    ambugest_order_id = fields.Integer(string='Ambugest Order ID',
                                       help="'order_id' field in Ambugest")
...
class AmbugestSaleOrderLine(models.Model):
    ...
    def create(self, vals):
        ...
        binding = super(AmbugestSaleOrderLine, self).create(vals)
...
class SaleOrder(models.Model):
    ...
    '''
    @api.depends('ambugest_bind_ids', 'magento_bind_ids.magento_parent_id')
